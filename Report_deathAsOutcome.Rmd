...
dat_lmtp <- read_rds(here::here("C:/Users/da.salazarb/Documents/data/derived/dat_final_deathAsOutcome.rds")) %>%
  ...
  select(-ckd_or_esrd, #-hypoxia_ed, ## 1 class
         ...
         -ethnicity_missing, -race_missing, -hypoxia_ed) ##ethnicity_missing == ethnicity_miss
         ## checking these ones:
         # -cirrhosis,
         #-smoking_active_smoker, -hypoxia_ed_method_venti_mask,
         #-hypoxia_ed_method_niv_bipap_cpap, 
